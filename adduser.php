            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12   col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="adduser.php" method="post" class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" name="address" class="form-control ps-0 form-control-line"></textarea>
                                        </div>
                                    </div>
